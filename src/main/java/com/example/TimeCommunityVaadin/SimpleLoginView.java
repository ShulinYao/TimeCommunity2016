...
Button.ClickListener {
	...
	public SimpleLoginView() {
		System.out.println("SimpleLoginView created");
		setSizeFull();
		
		// Create the user input field
		user = new TextField("User:");
		user.setWidth("300px");
		user.setRequired(true);//must be filled
		user.setInputPrompt("Your username (eg. test@gmail.com)");
		...
		fields.setCaption(
				"Please login to access the application. (boom@abo.fi/timecommunity123)");
	...
	public void buttonClick(ClickEvent event) {
		...
		//
		boolean isValid = username.equals("boom@abo.fi")
		        && password.equals("timecommunity123");
